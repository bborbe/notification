...
type SchemaLister interface {
	...
	List(selector labels.Selector) (ret []*cdbbenjaminborbedev1.Schema, err error)
...
type schemaLister struct {
	listers.ResourceIndexer[*cdbbenjaminborbedev1.Schema]
}

// NewSchemaLister returns a new SchemaLister.
func NewSchemaLister(indexer cache.Indexer) SchemaLister {
	return &schemaLister{listers.New[*cdbbenjaminborbedev1.Schema](indexer, cdbbenjaminborbedev1.Resource("schema"))}
}

// Schemas returns an object that can list and get Schemas.
func (s *schemaLister) Schemas(namespace string) SchemaNamespaceLister {
	return schemaNamespaceLister{listers.NewNamespaced[*cdbbenjaminborbedev1.Schema](s.ResourceIndexer, namespace)}
}
...
type SchemaNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*cdbbenjaminborbedev1.Schema, error)
