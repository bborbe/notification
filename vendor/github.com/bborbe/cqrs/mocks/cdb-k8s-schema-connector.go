...
func (fake *CdbK8sSchemaConnector) Listen(arg1 context.Context, arg2 cache.ResourceEventHandler) error {
...
func (fake *CdbK8sSchemaConnector) recordInvocation(key string, args []interface{}) {
...
var _ cdb.K8sSchemaConnector = new(CdbK8sSchemaConnector)
